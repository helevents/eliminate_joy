    ...
    Ajax({
        ...
        success: function success(res) {
            ...
            if (res.cg.data) {
                ...
                for (var _i13 = 0; _i13 < cglistsCount; _i13++) {
                    ...
                    _newLiChild.innerHTML = '<span class="rank-num">' + _rank + '</span><span class="rank-name">' + res.cg.data[_i13].nickname + '</span><span class="rank-score">' + res.cg.data[_i13].score + '</span>';
                }
            }
        }
    });
