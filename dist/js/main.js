...
console.log(pub.clickedImg); 
console.log(pub.disslovedImg);
    ...
    class Animal {
        ...
        clicked () {
            ...
            clickedImg.forEach(function(element, index) {
                if (that.img === element) {
                    imgIndex = index;
                }
            });
    ...
    pub.canvas.addEventListener('touchstart', function(e) {
        ...
        matrix[startInt.x / pub.imgWidth][startInt.y / pub.imgHeight].clicked(); 
    });
